...
```
bash
curl -sSL [https://github.com/xingfu111/proxy-manager/blob/main/proxy-manager.sh](https://raw.githubusercontent.com/xingfu111/proxy-manager/refs/heads/main/proxy-manager.sh) | bash
```
